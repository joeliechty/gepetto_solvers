...
Run (from the ``python/`` directory):
    python -m tests.tendon_hand.fk_pinch_centroids
"""
...
from .config import default_hand_tip_radii
from .solvers import (HandFKSolver, HandSolveParams, solved_wrist_pose,
                      tip_gap_matrix)
from .utils import PlannerLogger
