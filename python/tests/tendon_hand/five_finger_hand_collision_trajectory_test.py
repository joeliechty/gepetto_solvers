...
from ..tendon_finger.utils import PlannerLogger
...
def plan_trajectory(args, configs, label):
...
def _main(args, results_dir):
    ...
    if args.baseline:
        ...
        result_off = plan_trajectory(args, configs_off, "OFF")
    ...
    result = plan_trajectory(args, configs, "ON")
