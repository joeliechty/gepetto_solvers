...
Run ``python -m python.tests.tendon_hand.mount`` (from ``crest-sparse/``) for the
...
from .config import (FINGER_NAMES, finger_base_offset, load_hand_dimensions,
                     _Rx, _Ry, _Rz)
from .solvers import R_to_euler
...
def measured_mount_pose():
    ...
    """
    from .solvers import wrist_pose_from_xyzrpy
