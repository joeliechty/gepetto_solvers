...
Run from the ``crest-sparse/python`` directory::
    ...
    python scripts/objects/ycb_browser.py          # then open http://localhost:8082
    python scripts/objects/ycb_browser.py --fit 043_phillips_screwdriver
    python scripts/objects/ycb_browser.py --prefetch 011_banana 013_apple
