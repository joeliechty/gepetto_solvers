...
``mount_onshape_fit.sh.example`` next to this file. Run from ``crest-sparse/``::
    ...
    python scripts/experimental/mount_onshape_fit.py --list
    python scripts/experimental/mount_onshape_fit.py --instance hand
"""
...
from gepetto_solvers.projects.robot_mount import mount
from gepetto_solvers.projects.robot_mount.mount import DIGIT_NAMES
