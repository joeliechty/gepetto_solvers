...
public:
    ...
    // variable instead of its own; used by HandModel so several fingers
    ...
    // base-pose prior. Used when an owner (e.g. HandModel) anchors the
...
protected:
    ...
    // when an owner (HandModel) anchors the shared hand base itself.
